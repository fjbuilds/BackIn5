...
const STS_SCENARIOS = [
  ...
  },
  {
    ...
    icon: 'message',
    steps: [
      'Customer messages your business page on Facebook',
      'Instant reply sent automatically within seconds',
      'Job details and any photos requested and collected',
      'Customer books a callback or site visit',
      'Enquiry arrives in your dashboard, ready to quote',
    ],
  },
  {
